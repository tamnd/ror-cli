...
Most of these come down to network reality or how ror serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

ror rate-limits like any public site. ror already paces
...
Where a surface is gated, ror reads a cookie or token you supply
...
`ror`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what ror actually did
